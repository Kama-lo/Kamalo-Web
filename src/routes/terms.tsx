...
import { ShieldAlert, Scale, ShoppingBag, Users, Landmark, AlertTriangle, FileCheck } from "lucide-react";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Terms of Service — KAMALO" },
      {
        ...
        content:
          "Terms of Service governing KAMALO platform, rewards, and referral system.",
      },
    ...
    >
      ...
      <section id="kyc-compliance" className="scroll-mt-32 space-y-4">
        ...
        <p>
          ...
          guidelines, you must submit valid, verified documentation before you can disburse rewards or execute bank account
          transfers.
        </p>
      ...
      <section id="rewards-referrals" className="scroll-mt-32 space-y-4">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            ...
            Hold commissions are subject to monthly qualification criteria and active network participation requirements.
          </li>
          <li>
      ...
      <section id="merchant-settlements" className="scroll-mt-32 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-bold text-foreground">Partner Merchant Transactions & Settlements</h2>
        </div>
        <p>
          When executing purchases, utility bill payments, or transactions with partner merchants linked within the KAMALO
          ecosystem, all order fulfillment and deliveries are handled directly by the respective third-party merchant.
        </p>
        <div className="grid gap-3 sm:grid-cols-2 text-xs">
          <div className="rounded-xl border border-border bg-surface/50 p-4 space-y-1.5">
            ...
            <p className="text-muted-foreground">
              Product delivery, service quality, returns, and fulfillment disputes must be addressed directly with the
              respective third-party merchant or platform partner. The Company bears no liability for unfulfilled merchant
              orders or merchant inventory issues.
            </p>
          </div>
          <div className="rounded-xl border border-border bg-surface/50 p-4 space-y-1.5">
            <div className="flex items-center gap-2 font-semibold text-foreground">
            ...
            <p className="text-muted-foreground">
              Transactions depend on external banking and payment gateway infrastructure. Kamal Intellect is not liable
              for temporary downtime, gateway timeouts, or network interruptions outside our direct technical control.
            </p>
          </div>
        </div>
      </section>
